                                            ...
                                            neuton_i32_t* p_features)
{
    ...
    {
        p_features += neuton_dsp_pipeline_stat_compute_i16(p_input, num, mask.features.stat,
    ...
    {
        p_features += neuton_dsp_pipeline_spectr_compute_i16(p_input, num, mask.features.spectr,
                                                            get_argument, p_features);
    }
#endif
