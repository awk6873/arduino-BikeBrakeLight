...
#define NEUTON_NN_USE_INPUT_WINDOW              (NEUTON_NN_INPUT_FEATURE_SAMPLES_NUM > 1)
...
/** Determines whether neural network use extracted features for inference */
...
#define NEUTON_NN_INPUTS_WINDOW_SIZE            (NEUTON_NN_INPUT_UNIQ_FEATURES_USED_NUM * NEUTON_NN_INPUT_FEATURE_SAMPLES_NUM)
...
#pragma message "NEUTON_NN_INPUT_TYPE " NEUTON_NN_INPUT_TYPE
...
#define funcwrapper_activation(c, accum)         neuton_nn_activation_exp_f32(c, accum)
...
#define funcwrapper_clip_var(var, min, max);     /* no clipping */
...
#define funcwrapper_activation(c, accum)         neuton_nn_activation_exp_q(c, accum)
#else
#define funcwrapper_activation(c, accum)         neuton_nn_activation_sigmoid_q(NEUTON_NN_PREPARE_QCOEFF(c, accum))
...
neuton_coeff_t neuton_nn_activation_exp_f32(neuton_coeff_t acoeff, neuton_accum_t acc)
{
 ...
 */
__NEUTON_STATIC_FORCEINLINE 
neuton_coeff_t neuton_nn_activation_exp_q(neuton_coeff_t acoeff, neuton_accum_t acc)
{
