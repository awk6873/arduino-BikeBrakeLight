 ...
 * @param[in]   num       Number of samples in input vector
 *
 * @return  neuton_i16_t  Average Magnitude Difference value in the vector, multiplied by NEUTON_INT_TO_F32_PRECISION_FACTOR
 */
 ...
 * @param[in]   num       Number of samples in input vector
 *
 * @return  neuton_i32_t  Average Magnitude Difference value in the vector, multiplied by NEUTON_INT_TO_F32_PRECISION_FACTOR
 */
