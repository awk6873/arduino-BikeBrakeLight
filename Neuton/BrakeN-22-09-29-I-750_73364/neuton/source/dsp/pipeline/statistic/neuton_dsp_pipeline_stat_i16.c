#include <neuton/dsp/pipeline/neuton_dsp_pipeline_stat.h>
...
{
    neuton_dsp_stat_ctx_i16_t* p_ctx = NULL;
...
// ///////////////////////////////////////////////////////////////////////////
     ...
     *  is greater than the cost of allocating neuton_dsp_stat_ctx_i16_t */
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    if (feature_mask.is.min)
    {
        *p_features = neuton_dsp_min_i16(p_input, num);
        p_features++;
    }
#endif
    ...
    if (feature_mask.is.max)
    {
        *p_features = neuton_dsp_max_i16(p_input, num);
        p_features++;
    }
#endif
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    if (feature_mask.is.range)
    {
        if (feature_mask.is.min || feature_mask.is.max)
            ...
            *p_features = neuton_dsp_range_i16(p_input, num);
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        *p_features = neuton_dsp_mean_i16(p_input, num, p_ctx);
        p_features++;
    }
#endif
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        *p_features = neuton_dsp_mad_i16(p_input, num, p_ctx);
        p_features++;
    }
#endif
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        neuton_dsp_moments_i16_t m;
        memset(&m, 0, sizeof(m));

        neuton_dsp_moments_i16(p_input, num, p_ctx, &m);
    ...
    if (feature_mask.is.skew)
    {
        *p_features = neuton_dsp_skew_i16(p_input, num, p_ctx);
        p_features++;
    }
#endif
    ...
    if (feature_mask.is.kur)
    {
        *p_features = neuton_dsp_kur_i16(p_input, num, p_ctx);
        p_features++;
    }
#endif
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        *p_features = neuton_dsp_stddev_i16(p_input, num, p_ctx);
        p_features++;
    }
#endif
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        *p_features = neuton_dsp_rms_i16(p_input, num, p_ctx);
        p_features++;
    }
#endif
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        *p_features = neuton_dsp_mcr_i16(p_input, num, p_ctx);
        p_features++;
    }
#endif
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        *p_features = neuton_dsp_zcr_i16(p_input, num);
        p_features++;
    }
#endif
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    {
        neuton_i16_t threshold;
        get_argument(NEUTON_DSP_PIPELINE_STAT, NEUTON_DSP_STAT_FID_TCR, 1, &threshold);

        *p_features = neuton_dsp_tcr_i16(p_input, num, threshold);
        p_features++;
    }
#endif
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
    ...
    if (feature_mask.is.p2p_lf || feature_mask.is.p2p_hf)
    {
        ...
        neuton_dsp_pk2pk_lf_hf_i16(p_input, num, (size_t)window, &lf, &hf);
    ...
    if (feature_mask.is.p2p_lf)
    {
        ...
        *p_features = neuton_dsp_pk2pk_lf_i16(p_input, num, (size_t)window);
        p_features++;
    }
#endif
    ...
    if (feature_mask.is.p2p_hf)
    {
        ...
        *p_features = neuton_dsp_pk2pk_hf_i16(p_input, num, (size_t)window);
        p_features++;
    }
#endif
