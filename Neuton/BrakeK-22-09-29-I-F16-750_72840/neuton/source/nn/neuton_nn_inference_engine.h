 ...
 *        to get results use @ref neuton_nn_engine_get_inference_results
 * 
 ...
 */
void neuton_nn_engine_make_inference(const neuton_input_t* p_input_features,
 ...
 */
neuton_i16_t neuton_nn_engine_get_inference_results(neuton_u16_t* p_index, 
 ...
 */
neuton_coeff_t neuton_nn_activation_sigmoid_q(neuton_accum_t acc);

/**
 * @brief Get Neuton model size in bytes
 */
neuton_u32_t neuton_nn_engine_model_size(void);
