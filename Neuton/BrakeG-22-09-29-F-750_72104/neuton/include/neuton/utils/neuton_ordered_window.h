/**
 *
 * @defgroup neuton_ordered_window Ordered by colums window
 * @{
...
/**
 * @brief Ordered by colums window context
 * 
 */
typedef struct
{
...
/**
 * @brief Initialize ordered by colums window context type 
 * 
 * @param[in,out]   p_ctx               Pointer to the window context which will be initialized
