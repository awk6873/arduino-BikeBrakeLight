#include <neuton/dsp/support/neuton_dsp_scale_zscore.h>
#include <neuton/private/common/neuton_common.h>
                                ...
                                neuton_i16_t* p_output)
{
    ...
    while (loop_cnt > 0U)
    {
        *p_output++ = ((neuton_i32_t)(*p_input++ - mean) * NEUTON_INT16_QFACTOR) / stddev;
        *p_output++ = ((neuton_i32_t)(*p_input++ - mean) * NEUTON_INT16_QFACTOR) / stddev;
        *p_output++ = ((neuton_i32_t)(*p_input++ - mean) * NEUTON_INT16_QFACTOR) / stddev;
        *p_output++ = ((neuton_i32_t)(*p_input++ - mean) * NEUTON_INT16_QFACTOR) / stddev;
