...
static neuton_i32_t var_by_sum_n_tss_(neuton_i32_t sum, neuton_u64_t sum_of_squares,
                                     neuton_u16_t num)
{
...
static neuton_i32_t var_by_mean_(const neuton_i16_t* p_input, neuton_u16_t num, 
...
static neuton_i32_t var_by_mean_s_(const neuton_i16_t* p_input, neuton_u16_t num, 
                                ...
                                neuton_dsp_stat_ctx_i16_t* p_ctx)
{
    ...
    if (p_ctx)
    {
        ...
        case ONLY_TSS_AVALIABLE:
            var = var_by_sum_n_tss_(neuton_dsp_sum_i16(p_input, num, p_ctx), p_ctx->value.tss, num);
            break;
                                ...
                                size_t stride, neuton_dsp_stat_ctx_i16_t* p_ctx)
{
    ...
    if (p_ctx)
    {
        ...
        case TSS_AND_SUM_AVALIABLE:
            ...
            break;
        case ONLY_TSS_AVALIABLE:
            var = var_by_sum_n_tss_(neuton_dsp_sum_i16_s(p_input, num, stride, p_ctx), p_ctx->value.tss, num);
            break;
        case ONLY_SUM_AVALIABLE:
