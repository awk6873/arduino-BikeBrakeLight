...
static neuton_f32_t kur_and_var_(const neuton_f32_t* p_input, neuton_u16_t num,
...
static neuton_f32_t kur_and_var_s_(const neuton_f32_t* p_input, neuton_u16_t num,
...
static neuton_f32_t kur_(const neuton_f32_t* p_input, neuton_u16_t num,
...
static neuton_f32_t kur_s_(const neuton_f32_t* p_input, neuton_u16_t num,
                                ...
                                neuton_dsp_stat_ctx_f32_t* p_ctx)
{
    ...
    case SUM_AND_VAR_AVAILABLE:
        ...
        kur = kur_(p_input, num, mean, p_ctx->value.var);
        break;
    case SUM_AVAILABLE:
        mean = p_ctx->value.sum / num;
        kur = kur_and_var_(p_input, num, p_ctx, mean);
                                    ...
                                    size_t stride, neuton_dsp_stat_ctx_f32_t* p_ctx)
{
    ...
    case CTX_NOT_AVAILABLE:
        ...
        kur = kur_and_var_s_(p_input, num, stride, p_ctx, mean);
        break;
    case SUM_AND_VAR_AVAILABLE:
        mean = p_ctx->value.sum / num;
        kur = kur_s_(p_input, num, stride, mean, p_ctx->value.var);
        break;
    case SUM_AVAILABLE:
        mean = p_ctx->value.sum / num;
        kur = kur_and_var_s_(p_input, num, stride, p_ctx, mean);
