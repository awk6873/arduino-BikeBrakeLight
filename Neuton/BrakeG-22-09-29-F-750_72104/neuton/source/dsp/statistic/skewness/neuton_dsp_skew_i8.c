...
static neuton_i16_t f24_moments_to_skew_(neuton_f24_t m2, neuton_f24_t m3)
{
    ...
    return (neuton_i16_t)f24_to_i32(skew, SKEW_REQUIRED_EXP); 
}

// ///////////////////////////////////////////////////////////////////////////

static neuton_i16_t skew_and_var_(const neuton_i8_t* p_input, neuton_u16_t num,
                                neuton_dsp_stat_ctx_i8_t* p_ctx, const neuton_i8_t mean)
{
    neuton_u8_t sign;
    neuton_i8_t shift;
...
static neuton_i16_t skew_(const neuton_i8_t* p_input, neuton_u16_t num,
                           const neuton_i8_t mean, const neuton_i16_t var)
{
    ...
    return (neuton_i16_t)f24_to_i32(m3, SKEW_REQUIRED_EXP);
}
