...
#include <neuton_generated/neuton_user_model.inc>
...
neuton_i16_t neuton_nn_engine_get_inference_results(neuton_u16_t* index, 
...
neuton_coeff_t neuton_nn_activation_sigmoid_q(neuton_accum_t accum)
{
