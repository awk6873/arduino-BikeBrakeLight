                                ...
                                neuton_i32_t* p_pk2pk_lf, neuton_i32_t* p_pk2pk_hf)
{
    ...
    neuton_i32_t hf_min;
    neuton_i32_t hf_max;
    neuton_i32_t lf_movavg_sum = 0;
    neuton_i32_t hf_movavg_sum = 0;
    const size_t half_window_size = window_size >> 1;
    const neuton_i16_t* p_input_ws = (p_input + window_size);
    const neuton_i16_t* p_input_hws = (p_input + half_window_size + 1);
