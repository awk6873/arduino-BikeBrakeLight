                                            ...
                                            neuton_f32_t* p_features)
{
    ...
    {
        p_features += neuton_dsp_pipeline_stat_compute_f32(p_input, num, mask.features.stat,
    ...
    {
        p_features += neuton_dsp_pipeline_spectr_compute_f32(p_input, num, mask.features.spectr,
                                                            get_argument, p_features);
    }
#endif
