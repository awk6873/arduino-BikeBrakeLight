/**
 *
 * @defgroup neuton_dsp_pipeline_spectr Spectral features
 * @{
 ...
 *
 */
#ifndef _NEUTON_DSP_PIPELINE_SPECTR_H_
#define _NEUTON_DSP_PIPELINE_SPECTR_H_
...
/**
 * @brief Compute DSP spectral features from floating-point vector
 * 
...
/**
 * @brief Compute DSP spectral features from INT8 fixed-point vector
 * 
 * @param[in]   p_input         Pointer to the input vector
 * @param[in]   num             Number of samples in the input vector
 * @param[in]   feature_mask    The mask that determines which features will be extracted in runtime,
...
/**
 * @brief Compute DSP spectral features from INT16 fixed-point vector
 * 
 * @param[in]   p_input         Pointer to the input vector
 * @param[in]   num             Number of samples in the input vector
 * @param[in]   feature_mask    The mask that determines which features will be extracted in runtime,
...
#endif /* _NEUTON_DSP_PIPELINE_SPECTR_H_ */
