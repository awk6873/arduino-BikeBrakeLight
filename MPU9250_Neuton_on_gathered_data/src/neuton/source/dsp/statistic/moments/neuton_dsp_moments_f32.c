...
#define EXCESS_KURTOSIS(kur)     ((kur) - 3.0f)  

// ///////////////////////////////////////////////////////////////////////////

static void var_skew_kur_(const neuton_f32_t* p_input, neuton_u16_t num,
                        ...
                        neuton_dsp_moments_f32_t* p_m)
{
    ...
    p_m->moment.kur  = EXCESS_KURTOSIS(m4 / (m2 * m2));
...
static void var_skew_kur_s_(const neuton_f32_t* p_input, neuton_u16_t num, size_t stride,
                        neuton_dsp_stat_ctx_f32_t* p_ctx, neuton_f32_t mean,
                        neuton_dsp_moments_f32_t* p_m)
{
    neuton_f32_t diff;
...
static void skew_kur_(const neuton_f32_t* p_input, neuton_u16_t num,
                        ...
                        neuton_dsp_moments_f32_t* p_m)
{
    ...
    p_m->moment.kur  = EXCESS_KURTOSIS(m4 / (var * var));
}

// ///////////////////////////////////////////////////////////////////////////

static void skew_kur_s_(const neuton_f32_t* p_input, neuton_u16_t num, size_t stride,
                        neuton_f32_t mean, neuton_f32_t var,
                        neuton_dsp_moments_f32_t* p_m)
{
    NEUTON_DSP_RETURN_IF(var == 0, NEUTON_VOID_VALUE);
                            ...
                            neuton_dsp_stat_ctx_f32_t* p_ctx, neuton_dsp_moments_f32_t* p_m)
{
    ...
    case CTX_NOT_AVAILABLE:
        ...
        var_skew_kur_(p_input, num, p_ctx, mean, p_m);
        break;
    case SUM_AND_VAR_AVAILABLE:
        mean = p_ctx->value.sum / num;
        skew_kur_(p_input, num, mean, p_ctx->value.var, p_m);
        break;
    case SUM_AVAILABLE:
        mean = p_ctx->value.sum / num;
        var_skew_kur_(p_input, num, p_ctx, mean, p_m);
                            ...
                            neuton_dsp_stat_ctx_f32_t* p_ctx, neuton_dsp_moments_f32_t* p_m)
{
    ...
    case CTX_NOT_AVAILABLE:
        ...
        var_skew_kur_s_(p_input, num, stride, p_ctx, mean, p_m);
        break;
    case SUM_AND_VAR_AVAILABLE:
        mean = p_ctx->value.sum / num;
        skew_kur_s_(p_input, num, stride, mean, p_ctx->value.var, p_m);
        break;
    case SUM_AVAILABLE:
        mean = p_ctx->value.sum / num;
        var_skew_kur_s_(p_input, num, stride, p_ctx, mean, p_m);
