...
neuton_i16_t neuton_dsp_min_i16(const neuton_i16_t* p_input, neuton_u16_t num)
{
...
neuton_i16_t neuton_dsp_min_i16_s(const neuton_i16_t* p_input, neuton_u16_t num, 
                                size_t stride)
{
    neuton_u16_t loop_cnt;
    neuton_i16_t new_val;
